...
export function StoryCard({ work }: { work: Work }) {
  return (
    <article className="group flex h-[352px] flex-col overflow-hidden rounded-lg border border-border bg-card shadow-card transition duration-200 hover:-translate-y-1 hover:border-[color:var(--border-hover)]">
